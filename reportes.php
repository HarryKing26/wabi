...
<head>
    ...
    <title>Reportes - Wabi-Sabi Japan Tours</title>
...
<body>
    ...
    <div class="reportes-container">
        <h2 class="titulo-pagina">Reportes y Estadísticas</h2>
        ...
        <div class="filtros-container">
            ...
            <form method="GET" action="reportes.php">
                    ...
                    <div class="form-group">
                        ...
                        <select id="paquete" name="paquete">
                            ...
                            <?php foreach ($paquetes as $paq): ?>
                                <option value="<?= htmlspecialchars($paq) ?>" <?= ($filtros['paquete'] == $paq) ? 'selected' : '' ?>>
                                    <?= htmlspecialchars($paq) ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select id="destino" name="destino">
                            ...
                            <?php foreach ($destinos as $des): ?>
                                <option value="<?= htmlspecialchars($des) ?>" <?= ($filtros['destino'] == $des) ? 'selected' : '' ?>>
                                    <?= htmlspecialchars($des) ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select id="estado" name="estado">
                            ...
                            <?php foreach ($estados as $est): ?>
                                <option value="<?= htmlspecialchars($est) ?>" <?= ($filtros['estado'] == $est) ? 'selected' : '' ?>>
                ...
                <div class="grid-filtros" style="grid-template-columns: 1fr 1fr; margin-top: 15px;">
                    <button type="submit" class="btn btn-filtrar">Aplicar Filtros</button>
                    <a href="reportes.php" class="btn btn-limpiar">Limpiar Filtros</a>
                </div>
            </form>
        </div>
        ...
        <div class="estadisticas-grid">
            <div class="tarjeta-estadistica">
                ...
                <div class="valor"><?= number_format($estadisticas['total_pedidos']) ?></div>
                <div class="descripcion">Solicitudes recibidas</div>
                <i class="fas fa-clipboard-list" style="font-size: 2em; color: rgba(218, 41, 28, 0.2); margin-top: 10px;"></i>
            </div>
            
            <div class="tarjeta-estadistica">
                <h3>Promedio de Pasajeros</h3>
                <div class="valor"><?= number_format($estadisticas['promedio_pasajeros'], 1) ?></div>
                <div class="descripcion">Por reserva</div>
                <i class="fas fa-users" style="font-size: 2em; color: rgba(218, 41, 28, 0.2); margin-top: 10px;"></i>
            </div>
            
            <div class="tarjeta-estadistica">
                <h3>Paquete Más Popular</h3>
                <div class="valor">
                    <?php 
                    if (!empty($estadisticas['por_paquete'])) {
                        $paquete_popular = array_reduce($estadisticas['por_paquete'], function($a, $b) {
                            return $a['cantidad'] > $b['cantidad'] ? $a : $b;
                        });
                        echo htmlspecialchars($paquete_popular['paquete']);
                    } else {
                        echo 'N/A';
                    }
                    ?>
                ...
                <div class="descripcion">
                    <?= !empty($paquete_popular) ? number_format($paquete_popular['cantidad']) . ' reservas' : '' ?>
                </div>
                <i class="fas fa-star" style="font-size: 2em; color: rgba(218, 41, 28, 0.2); margin-top: 10px;"></i>
            </div>
            ...
            <div class="tarjeta-estadistica">
                ...
                <div class="valor">
                    <?php 
                    if (!empty($estadisticas['por_destino'])) {
                        $destino_popular = array_reduce($estadisticas['por_destino'], function($a, $b) {
                            return $a['cantidad'] > $b['cantidad'] ? $a : $b;
                        });
                        echo htmlspecialchars($destino_popular['destino']);
                    } else {
                        echo 'N/A';
                    }
                    ?>
                ...
                <div class="descripcion">
                    <?= !empty($destino_popular) ? number_format($destino_popular['cantidad']) . ' reservas' : '' ?>
                </div>
                <i class="fas fa-map-marker-alt" style="font-size: 2em; color: rgba(218, 41, 28, 0.2); margin-top: 10px;"></i>
            </div>
        </div>
        ...
        <div class="graficos-grid">
            ...
            <div class="grafico-container">
                ...
                <canvas id="graficoPaquetes"></canvas>
            </div>
            
            <div class="grafico-container">
                <h3>Preferencia de Destinos</h3>
        ...
        <div class="graficos-grid">
            ...
            <div class="grafico-container">
                <h3>Promedio de Pasajeros por Paquete</h3>
                <canvas id="graficoPromedioPaquete"></canvas>
            </div>
        </div>
